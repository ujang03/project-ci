...
--
-- Host: localhost:3306
-- Generation Time: Nov 09, 2023 at 01:15 AM
...
(5, 'Projector EPSON  EB-X51', 5, 2),
(6, 'Logitech C270 Webcam HD 720P', 5, 2),
...
--
-- Table structure for table `tb_trans_peminjaman`
--

CREATE TABLE `tb_trans_peminjaman` (
  `id` int NOT NULL,
...
(7, 'edi', 'edi@gmail.com', NULL, '', 1, 1, 0),
...
--
-- Indexes for table `tb_trans_peminjaman`
--
ALTER TABLE `tb_trans_peminjaman`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT for table `tb_trans_peminjaman`
--
ALTER TABLE `tb_trans_peminjaman`
  MODIFY `id` int NOT NULL AUTO_INCREMENT;
...
--
-- Constraints for table `tb_trans_peminjaman`
--
ALTER TABLE `tb_trans_peminjaman`
  ADD CONSTRAINT `fk_barang` FOREIGN KEY (`id_barang`) REFERENCES `tb_barang` (`id_barang`) ON DELETE CASCADE ON UPDATE RESTRICT,
  ADD CONSTRAINT `fk_peminjam` FOREIGN KEY (`id_peminjam`) REFERENCES `tb_peminjam` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT,
  ADD CONSTRAINT `fk_user` FOREIGN KEY (`id_user`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT;
COMMIT;
